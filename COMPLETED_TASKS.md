...
- ✅ [AUTO] Release Please #22 merged (`v0.8.0`)
...
- ✅ [AUTO] `pre-release-gate.sh` (local + push-SHA CI/CodeQL/Security Scan)
- ✅ [HUMAN] Approve release tag when product-ready (`/ship`)
- ✅ [AUTO] Release Please #10 merged (`v0.2.4`)
...
- ✅ [AUTO] `pre-release-gate.sh` (local + push-SHA CI/CodeQL/Security Scan)
- ✅ [HUMAN] Approve release tag when product-ready (`/ship`)
- ✅ [AUTO] Release Please #6 merged (`v0.2.2`)

## /ship v0.2.1 (2026-08-16)

- ✅ [AUTO] `pre-release-gate.sh` (local + push-SHA CI/CodeQL/Security Scan)
- ✅ [HUMAN] Approve release tag when product-ready (`/ship`)
- ✅ [AUTO] Release Please #4 merged (`v0.2.1`)
...
- ✅ [AGENT] `init-project.ps1 -Stack android -Prune -PruneOptional -DistributionTier foss`
- ✅ [AGENT] Product identity, ADRs, privacy/threat/runbook, BUILD_PLAN playbook
