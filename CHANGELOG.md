...
* **android:** tap announcement history to mute the app in OpenShouter or open that notification channel in system settings
* **ci:** required-check rollup jobs named CI, Security Scan, and CodeQL so PRs can merge without an admin bypass
...
* record v0.8.1 ship milestone ([0ac31cd](https://github.com/edwardlthompson/OpenShouter/commit/0ac31cd503619e9728a59a29298591a88e8e5274))
...
* record v0.3.0 ship regressions ([38c6510](https://github.com/edwardlthompson/OpenShouter/commit/38c65108b2de2062be1d841bbeafe91e49f0484b))
...
* record v0.2.3 ship regressions ([5b35ff9](https://github.com/edwardlthompson/OpenShouter/commit/5b35ff9a75be205d5d8754da223810bc461af924))
...
* record v0.2.1 ship regressions ([52b482e](https://github.com/edwardlthompson/OpenShouter/commit/52b482ed18f8622cac12e0793ce87b96edc2e874))
...
* **openshouter:** FOSS Android announcer in examples/android/ — notification TTS, looping caller ID, power/gesture mute, quiet hours, LocationManager geofences, foreground service, QS tile, and widget
* **branding:** flat launcher mark plus photorealistic splash and README hero
* **dist:** GitHub Releases only (no Play Store, no F-Droid listing)

### Fixed

* **privacy:** disable backup of notification history, prune Room to 100 rows, unexport debug TTS receiver, cap regex pattern length
* **gates:** skip About feature verification when examples/web is pruned
